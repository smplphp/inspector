...
class StaticTypeTest extends TestCase
{
    ...
    {
        $this->type = new StaticType(new ClassType(BasicInterface::class));
    }

    /**
     * @test
     */
    public function static_types_are_named_static(): void
    {
        self::assertSame('static', $this->type->getName());
    }
     ...
     * @test
     */
    public function static_types_are_not_builtin(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_arrays(): void
    {
     ...
     * @test
     */
    public function static_dont_types_match_bools(): void
    {
     ...
     * @test
     */
    public function static_types_matches_instances_of_class(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_floats(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_ints(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_iterables(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_null(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_objects(): void
    {
     ...
     * @test
     */
    public function static_types_dont_match_strings(): void
    {
     ...
     * @test
     */
    public function static_types_accept_nullable_versions_of_their_base_classes(): void
    {
        self::assertTrue($this->type->accepts('?' . BasicInterface::class));
        self::assertTrue($this->type->accepts(new NullableType($this->type->getBaseType())));
    }

    /**
     * @test
     */
    public function static_types_dont_accept_array_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_bool_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_false_types(): void
    {
     ...
     * @test
     */
    public function static_types_accept_same_class_types(): void
    {
        self::assertTrue($this->type->accepts(BasicInterface::class));
     ...
     * @test
     */
    public function static_types_accept_child_class_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_different_class_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_float_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_intersection_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_int_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_iterable_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_nullable_types_with_different_base_types(): void
    {
        self::assertFalse($this->type->accepts('?array'));
     ...
     * @test
     */
    public function static_types_dont_accept_object_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_string_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_union_types_with_different_base_types(): void
    {
     ...
     * @test
     */
    public function static_types_dont_accept_void_types(): void
    {
